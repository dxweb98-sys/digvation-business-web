    ...
    >
      ...
      <div className="mt-4 space-y-1">
        {transactions.length ? (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-0.5 truncate text-[11px] text-[var(--color-text-muted)]">
                  {formatDateTime(transaction.occurredAt)} · {String(transaction.sellingLocation ?? '—')}
                </p>
              </div>
          ...
          <div className="flex min-h-48 items-center justify-center text-center text-xs text-[var(--color-text-muted)]">
            {emptyMessage}
          </div>
        )}
      </div>
