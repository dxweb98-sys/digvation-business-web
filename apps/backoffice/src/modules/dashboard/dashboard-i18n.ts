...
const dashboardCopy = {
  ...
  finalizedSalesToday: { id: 'Transaksi selesai hari ini', en: 'Finalized sales today' },
  finalized: { id: 'Selesai', en: 'Finalized' },
  inProgress: { id: 'Berjalan', en: 'In progress' },
  voided: { id: 'Dibatalkan', en: 'Voided' },
  finalizedOf: { id: 'selesai', en: 'finalized' },
  ...
  businessInsight: { id: 'Ringkasan bisnis', en: 'Business insight' },
  insightComparison: { id: 'Bulan ini dibanding bulan sebelumnya', en: 'This month compared with the previous month' },
  insightSource: { id: 'Ringkasan berdasarkan data laporan.', en: 'Summary based on report data.' },
  ...
  salesUnavailableDescription: { id: 'Anda tidak memiliki akses ke ringkasan penjualan.', en: 'You do not have access to sales summary data.' },
  selectLocation: { id: 'Pilih cabang', en: 'Select a location' },
  selectLocationDescription: { id: 'Pilih cabang untuk melihat ringkasan dasbor.', en: 'Choose a branch to view dashboard summaries.' },
