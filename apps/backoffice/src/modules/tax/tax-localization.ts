...
const messages = {
  id: {
    ...
    saveProfile: 'Simpan profil', profileSaved: 'Profil pajak berhasil disimpan.', profileSaveFailed: 'Gagal menyimpan profil pajak.',
    code: 'Kode', name: 'Nama', status: 'Status', active: 'Aktif', inactive: 'Nonaktif', cancelled: 'Dibatalkan',
    addCategory: 'Tambah kategori', editCategory: 'Ubah kategori', categorySaved: 'Kategori pajak berhasil disimpan.', categorySaveFailed: 'Gagal menyimpan kategori pajak.', categoryEmpty: 'Belum ada kategori pajak.',
    ...
    addRule: 'Tambah aturan', ruleAdded: 'Aturan pajak berhasil ditambahkan.', ruleAddFailed: 'Gagal menambahkan aturan pajak.', ruleEmpty: 'Belum ada aturan pajak.',
    cancelRule: 'Batalkan aturan', cancelRuleTitle: 'Batalkan aturan pajak?', cancelRuleMessage: 'Aturan ini tidak akan digunakan untuk transaksi berikutnya.', ruleCancelled: 'Aturan pajak berhasil dibatalkan.', ruleCancelFailed: 'Gagal membatalkan aturan pajak.',
    effectiveFrom: 'Berlaku mulai', effectiveUntil: 'Berlaku sampai', optional: 'Opsional', immediate: 'Langsung', noEnd: 'Tanpa batas akhir',
    invalidPeriod: 'Tanggal akhir harus setelah tanggal mulai.',
    conflict: 'Periode aturan bertabrakan dengan aturan aktif lain untuk cakupan yang sama.',
    inactiveReference: 'Kategori yang dipilih sudah tidak aktif.', invalidInput: 'Periksa kembali data aturan pajak.', forbidden: 'Anda tidak memiliki izin untuk tindakan ini.', serverError: 'Layanan sedang bermasalah. Coba lagi.',
