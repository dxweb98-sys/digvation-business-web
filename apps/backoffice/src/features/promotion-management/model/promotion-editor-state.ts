...
export interface PromotionEditorUiState {
  saving: boolean;
  step: PromotionEditorStep;
}

export interface PromotionEditorState {
  form: PromotionEditorForm;
  ui: PromotionEditorUiState;
}

export function createPromotionEditorState(
