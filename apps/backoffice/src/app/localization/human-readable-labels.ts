...
const eventLabels: Record<string, LocalizedLabel> = {
  ...
  BUSINESS_LOCALIZATION_UPDATED: { id: 'Pengaturan regional diperbarui', en: 'Localization settings updated' },
  ...
  SALE_LINE_PRICE_OVERRIDDEN: { id: 'Harga item transaksi diubah', en: 'Transaction item price changed' },
  SALE_LINE_PRICE_OVERRIDE_REMOVED: { id: 'Perubahan harga item dibatalkan', en: 'Transaction item price override removed' },
