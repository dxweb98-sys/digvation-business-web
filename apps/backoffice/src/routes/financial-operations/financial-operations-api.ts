...
export class FinancialOperationsApi {
  ...
  movements(query: Query) { return this.client.get<Page<CashMovement>>(`/api/v1/cash-movements?${qs(query)}`); }
  ...
  settlements(query: Query) { return this.client.get<Page<Settlement>>(`/api/v1/settlements?${qs(query)}`); }
  ...
  reconciliations(query: Query) { return this.client.get<Page<Reconciliation>>(`/api/v1/reconciliations?${qs(query)}`); }
