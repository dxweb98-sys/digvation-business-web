  ...
  return (
    <BackofficePage>
      <BackofficePageHeader
        ...
        title={copy('Backoffice foundation')}
        description={copy(
          'No fake dashboard metrics are shown. Management capabilities appear only when their backend contract and frontend checkpoint are approved.',
        )}
      />
